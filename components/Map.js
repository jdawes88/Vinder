  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Zoom zoom={this.zoom} />
        <Marker pinType={this.props.pinType} dishes={this.props.dishes} />
      </MapView>
    );
  }
...
class Marker extends Component {
  ...
  linkToRestaurant = id => {
    NavigationService.navigate("RestaurantScreen", { restaurant: id });
  };
}
...
class Meals extends Component {
  ...
  renderCard = item => {
    return (
      <TouchableOpacity onPress={() => this.linkToRestaurant(item)}>
        <Card
